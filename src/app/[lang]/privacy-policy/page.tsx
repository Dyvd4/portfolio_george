	...
	return (
		...
		>
			...
			<p>
				...
				Палкин Георгий Михайлович (далее — Оператор).
				<br />
				...
				посетителях веб-сайта https://itsgeorge.design.
			</p>
			...
			<p>
				...
				сетевому адресу https://itsgeorge.design.
				<br />
				...
				<br />
				2.10. Пользователь — любой посетитель веб-сайта https://itsgeorge.design.
				<br />
			...
			<p>
				...
				<br />
				Цель обработкиинформирование Пользователя посредством отправки электронных
				писемПерсональные данные
				<br />
				электронный адрес
				<br />
				имя
			...
			<p>
				...
				электронной почты Оператора 4niklap@gmail.com с пометкой «Актуализация персональных
				данных».
				<br />
			...
			<p>
				...
				электронной почты 4niklap@gmail.com.
				<br />
				...
				адресу https://itsgeorge.design/policy/.
			</p>
		</div>
	);
}
